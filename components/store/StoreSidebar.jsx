...
import { HomeIcon, LayoutListIcon, MessageSquareWarningIcon, SquarePenIcon, SquarePlusIcon } from "lucide-react"
...
const StoreSidebar = ({storeInfo}) => {
    ...
    const sidebarLinks = [
        ...
        { name: 'Complaints', href: '/store/complaints', icon: MessageSquareWarningIcon },
        { name: 'Returns', href: '/store/returns', icon: MessageSquareWarningIcon },
    ]
